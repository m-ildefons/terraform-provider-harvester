...
func SRIOVGPUDeviceSchema() map[string]*schema.Schema {
...
func DataSourceSRIOVGPUDeviceSchema() map[string]*schema.Schema {
	return util.DataSourceSchemaWrap(SRIOVGPUDeviceSchema())
}
